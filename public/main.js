...
socket.on('phone-data', function (data) {
  ...
  if (aboveAbsThreshold(data.rotationRate.alpha*data.interval, 1) || aboveAbsThreshold(data.rotationRate.beta*data.interval, 1) || aboveAbsThreshold(data.rotationRate.gamma*data.interval, 1)) {
    var scalar = 100;
